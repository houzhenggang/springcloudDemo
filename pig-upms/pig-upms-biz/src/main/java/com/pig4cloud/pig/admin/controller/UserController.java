...
public class UserController {
	...
	public R user(@RequestBody UserDTO userDto) {
		...
		userDto.setLevel(level+1);
		userDto.setParentId(userVO.getUserId());
	...
	public R getUserPage(Page page, UserDTO userDTO) {
		Integer userId = SecurityUtils.getUser().getId();
		UserVO userVO = userService.selectUserVoById(userId);
		userVO.setParentId(userId);
		userVO.setUsername(userDTO.getUsername());
		userVO.setProxyName(userDTO.getProxyName());
		return new R<>(userService.getUsersWithRolePage(page, userVO));
	}
	...
	public R getUserList(UserDTO userDTO) {
		...
		userVO.setParentId(userId);
		userVO.setUsername(userDTO.getUsername());
		return new R<>(userService.getUsersWithRolePage(userVO));
	}
